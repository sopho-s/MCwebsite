...
<html>
    ...
    <body>
                    ...
                    if ($result["PageEditAccess"]) {
                        echo "<li class=\"menu\">
                                <form action=\"../Editpage.php\" method=\"post\">
                                    ...
                                    <input type=\"hidden\" name=\"origin\" value=\"Challenge_2\" class=\"upload\">
                                </form>
                            </li>";
                    }
                } catch(Exception $e) {
        ...
        <div class="src">
            <a href="../challengepages/challengesrc/Challenge_2src.php" class="src">Source Code</a>
        </div>
        ...
        <script>
            ...
            <?php
                $myfile = fopen("markdown/Challenge_2.md", "r");
                $text = explode("\n", str_replace("\r", "\n", fread($myfile,filesize("markdown/Challenge_2.md"))));
                fclose($myfile);
                $strarr = "[\"";
